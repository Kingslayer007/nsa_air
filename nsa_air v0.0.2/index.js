...
const adminUserMangementLinks = document.querySelector('#admin');
const empMangementLinks = document.querySelector('#emp');
const empVolMangementLinks = document.querySelectorAll('.vol-emp');



const manageUser = () => {
  adminUserMangementLinks.style.display = 'block';
};
const manageVol = () => {
  empMangementLinks.style.display = 'block';
  empVolMangementLinks.forEach(item => item.style.display = 'block');
};
...
const setupUI = (user,role) => {
  if (user) {
    ...
    loggedInOutLinks.forEach(item => item.style.display = 'block');
    adminUserMangementLinks.style.display = 'none';
    empMangementLinks.style.display = 'none';
  }
};
